...
| **ИТОГО**        | **46**                | Полнофункциональный API           |

### Статистика достижений

| Характеристика                      | Значение                          |
| ----------------------------------- | --------------------------------- |
| **Общее количество достижений**     | 37                                |
| **Типы достижений**                 | 7                                 |
