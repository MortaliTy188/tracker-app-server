...
7. [Описание утилит и автоматизации](#описание-утилит-и-автоматизации)
8. [Автоматическое тестирование](#автоматическое-тестирование)
9. [Ручное тестирование через Swagger](#ручное-тестирование-через-swagger)
10. [Структура проекта](#структура-проекта)
11. [Архитектура проекта](#архитектура-проекта)
12. [Практики разработки](#практики-разработки)
13. [Особенности проекта](#особенности-проекта)
14. [Блок со всеми командами сервера](#блок-со-всеми-командами-сервера)
...
| -------------------- | ----------------- | -------------------------------- |
| **JavaScript файлы** | 58                | Основной код приложения          |
| **Контроллеры**      | 9                 | Бизнес-логика API                |
| **Модели**           | 10                | Структуры данных Sequelize       |
| **Маршруты**         | 8                 | API роуты                        |
| **Утилиты**          | 4                 | Вспомогательные функции          |
| **Тесты**            | 17                | Автоматизированное тестирование  |
| **Middleware**       | 3                 | Промежуточное ПО                 |
| **Конфигурация**     | 2                 | Настройки БД и Swagger           |
| **Документация**     | 3                 | README и тестовая документация   |
...
| **categories_mastered** | За изучение категорий | Количество освоенных категорий    |
| **first_action**        | За первые действия    | Первый навык/тема/заметка         |

### Список всех достижений (33 шт.)
...
| Полувековой юбилей | 🎖️     | Завершить 50 топиков  | 200  | epic      |
| Сотня!             | 👑     | Завершить 100 топиков | 500  | legendary |
| Марафонец знаний   | 🏃‍♂️     | Завершить 200 топиков | 1000 | legendary |

#### 🌱 Достижения за созданные навыки (3 шт.)

| Название             | Иконка | Требование         | Очки | Редкость |
| -------------------- | ------ | ------------------ | ---- | -------- |
| Мой первый навык     | 🌱     | Создать 1 навык    | 5    | common   |
| Коллекционер навыков | 📚     | Создать 5 навыков  | 30   | rare     |
| Мастер многих дел    | 🎭     | Создать 10 навыков | 75   | epic     |

#### 📝 Достижения за заметки (4 шт.)

| Название          | Иконка | Требование          | Очки | Редкость |
| ----------------- | ------ | ------------------- | ---- | -------- |
| Первая заметка    | 📝     | Написать 1 заметку  | 5    | common   |
| Активный писатель | ✍️     | Написать 10 заметок | 40   | rare     |
| Хроникёр знаний   | �      | Написать 25 заметок | 80   | epic     |
| Мастер заметок    | 📚     | Написать 50 заметок | 200  | epic     |

#### 🥇 Достижения за уровни (3 шт.)

| Название             | Иконка | Требование                  | Очки | Редкость  |
| -------------------- | ------ | --------------------------- | ---- | --------- |
| Уровень: Базовый     | 🥉     | Достичь базового уровня     | 50   | common    |
| Уровень: Продвинутый | 🥈     | Достичь продвинутого уровня | 100  | rare      |
| Уровень: Эксперт     | 🥇     | Достичь уровня эксперта     | 250  | legendary |

#### 📁 Достижения за категории (3 шт.)

| Название         | Иконка | Требование                    | Очки | Редкость |
| ---------------- | ------ | ----------------------------- | ---- | -------- |
| Первая категория | 📁     | Освоить 1 категорию           | 30   | common   |
| Универсал        | 🌟     | Освоить 3 категории           | 100  | epic     |
| Исследователь    | 🔍     | Создать навыки в 5 категориях | 200  | epic     |

#### 👋 Достижения за первые действия (4 шт.)

| Название          | Иконка | Требование              | Очки | Редкость |
| ----------------- | ------ | ----------------------- | ---- | -------- |
| Добро пожаловать! | 👋     | Создать первый навык    | 5    | common   |
| Начинаем изучение | 🎬     | Создать первый топик    | 5    | common   |
| Первые записи     | 📄     | Написать первую заметку | 5    | common   |
| Первый успех      | 🎉     | Завершить первый топик  | 15   | common   |

#### 🎮 Специальные достижения (9 шт.)

| Название                | Иконка | Требование                              | Очки | Редкость |
| ----------------------- | ------ | --------------------------------------- | ---- | -------- |
| Перфекционист           | 💎     | Завершить 5 топиков подряд со 100%      | 150  | epic     |
| Спринтер                | ⚡     | Завершить 3 топика за день              | 100  | rare     |
| Продуктивный день       | 🌅     | Завершить 5 топиков за день             | 150  | rare     |
| Неделя целей            | 📅     | Завершать по топику каждый день недели  | 300  | epic     |
| Коллекционер достижений | 🏅     | Получить 10 различных достижений        | 250  | epic     |
| Утренняя активность     | 🌞     | Завершить топик до 9:00 утра            | 50   | rare     |
| Ночная сова             | �      | Завершить топик после 23:00             | 50   | rare     |
| Быстрый старт           | 🚀     | Завершить топик в час после регистрации | 100  | rare     |
| Возвращение             | �      | Вернуться после 30-дневного перерыва    | 75   | rare     |

**Общая статистика:**

- **Всего достижений:** 33
- **Общая сумма очков:** 4,785
- **Типы достижений:** 6 (topics_completed, skills_created, notes_written, level_reached, categories_mastered, first_action, special)
- **Уровни редкости:** 4 (common, rare, epic, legendary)
...
_Документация последний раз обновлена: 17.07.2025_
