...
7. [Описание системы достижений](#описание-системы-достижений)
8. [Описание системы уровней](#описание-системы-уровней)
9. [Система отслеживания активности](#система-отслеживания-активности)
10. [Описание утилит и автоматизации](#описание-утилит-и-автоматизации)
11. [Автоматическое тестирование](#автоматическое-тестирование)
12. [Ручное тестирование через Swagger](#ручное-тестирование-через-swagger)
13. [Структура проекта](#структура-проекта)
14. [Архитектура проекта](#архитектура-проекта)
15. [Практики разработки](#практики-разработки)
16. [Особенности проекта](#особенности-проекта)
17. [Блок со всеми командами сервера](#блок-со-всеми-командами-сервера)
...
| -------------------- | ----------------- | --------------------------------- |
| **JavaScript файлы** | 85+               | Основной код приложения           |
| **Контроллеры**      | 11                | Бизнес-логика API                 |
| **Модели**           | 12                | Структуры данных Sequelize        |
| **Маршруты**         | 10                | API роуты                         |
| **Утилиты**          | 6                 | Вспомогательные функции           |
| **Тесты**            | 20+               | Автоматизированное тестирование   |
| **Middleware**       | 5                 | Промежуточное ПО                  |
| **Setup/Миграции**   | 8                 | Скрипты настройки и миграций      |
| **Конфигурация**     | 2                 | Настройки БД и Swagger            |
| **Документация**     | 8                 | README и специальная документация |
...
| **ИТОГО**         | **55**                | Полнофункциональный API с социальными функциями        |
...
- `GET /api/users/all` - Получение списка всех пользователей с учетом приватности
- `PUT /api/users/privacy` - Обновление настроек приватности профиля
...
- **Пользовательские сообщения об ошибах**
...
_Документация последний раз обновлена: 20.07.2025_
